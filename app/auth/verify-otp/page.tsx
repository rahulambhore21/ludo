...
export default function VerifyOTPPage() {
  ...
  const [pendingAuth, setPendingAuth] = useState<{name: string, phone: string} | null>(null);
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      // Redirect to register if no pending auth
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Enter the 6-digit code sent to {pendingAuth.phone}
          </p>
